![Netlify Next.js Blog Template designed by Bejamas](./public/banner.svg)
...
![Preview of blog theme. Author named Jay Doe and blog's name is "Next.js Blog Theme" with one blog post](./public/preview.png)
